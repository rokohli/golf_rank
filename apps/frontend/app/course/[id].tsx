...
function HeroAttribution({ heroImage }: { heroImage?: HeroImage | null }) {
  ...
  return (
    <View style={styles.heroAttribution}>
      <Pressable accessibilityLabel={`Photo credit: ${credit}`} accessibilityRole={onPressCredit ? 'link' : 'text'} disabled={!onPressCredit} onPress={onPressCredit}>
...
const styles = StyleSheet.create({
  ...
  heroAttribution: { bottom: 30, left: 12, position: 'absolute', flexDirection: 'row' }, heroAttributionText: { color: 'rgba(255,255,255,0.85)', fontSize: 11, fontWeight: '500', textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 },
